<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-base-content leading-tight">{{ __('Dodaj uslugu') }}</h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('owner.services.store') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                class="mt-1 block w-full rounded-md border-base-200 bg-base-100 text-sm text-base-content"></textarea>
                        ...
                        <div class="form-control">
                            <label class="label cursor-pointer justify-start gap-4">
                                ...
                                <input type="checkbox" name="is_promoted" value="1" class="checkbox checkbox-primary" onchange="document.getElementById('discount_container').classList.toggle('hidden', !this.checked)" />
                            </label>
                        </div>
